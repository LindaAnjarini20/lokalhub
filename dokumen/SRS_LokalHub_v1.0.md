...
Dokumen mengikuti standar IEEE 830-1998. Prioritas ditandai: Tinggi / Sedang / Rendah. Kode fungsional: F-XX; non-fungsional: NF-XX. Istilah teknis didefinisikan di Appendix A.
1.3 Intended Audience and Reading Suggestions
•	Developer Backend/Frontend/Mobile: Bab 3, 4, dan 5.
•	Tim QA/Tester: Bab 4 (test case) dan Bab 5 (pengujian performa).
•	Manajer Proyek: Bab 1, 2, dan 4 (scope dan prioritas).
...
•	Midtrans API Docs — https://docs.midtrans.com | Laravel 11 — https://laravel.com/docs/11.x | Flutter 3.19 — https://docs.flutter.dev

2. Overall Description
2.1 Product Perspective
Platform LOKAL adalah produk baru (bukan pengganti sistem lama) berupa marketplace berbasis lokasi yang menghubungkan penjual UMKM dan pembeli dalam ekosistem tertutup. Bukan lembaga keuangan — seluruh transaksi melalui Midtrans. Komponen utama: Mobile App (Flutter), API Backend (Laravel 11), ML Service (Python/FastAPI), n8n Workflow Engine, MySQL 8.0, serta layanan eksternal Midtrans, Twilio, dan Google Maps API.
...
Mengelola identitas pengguna via OTP nomor telepon. Prioritas: TINGGI.
...
Fitur inti: peta interaktif UMKM terdekat dan katalog produk. Prioritas: TINGGI.
...
Mengelola seluruh alur transaksi dari pemilihan produk hingga konfirmasi. Prioritas: TINGGI.
